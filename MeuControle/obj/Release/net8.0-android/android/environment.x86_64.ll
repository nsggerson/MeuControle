...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 596521126675672284, ; hash 0x84744cde084ecdc, from name: aot-MeuControle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MeuControle.dll.so
		ptr null; void* handle (0x0)
	}, ; 14
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3885095683329355709, ; hash 0x35eaa1f09b3fefbd, from name: aot-MeuControle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MeuControle.dll.so
		ptr null; void* handle (0x0)
	}, ; 100
	...
	%struct.DSOCacheEntry {
		i64 9771534720933768938, ; hash 0x879b770e8fa72eea, from name: libaot-MeuControle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MeuControle.dll.so
		ptr null; void* handle (0x0)
	}, ; 243
	...
	%struct.DSOCacheEntry {
		i64 10534693586094552224, ; hash 0x9232c00058c074a0, from name: libaot-MeuControle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MeuControle.dll.so
		ptr null; void* handle (0x0)
	}, ; 266
	...
	%struct.DSOCacheEntry {
		i64 15412375783469189945, ; hash 0xd5e3c21de6838b39, from name: MeuControle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MeuControle.dll.so
		ptr null; void* handle (0x0)
	}, ; 401
	...
	%struct.DSOCacheEntry {
		i64 17113731174733530947, ; hash 0xed802fd4bb854743, from name: MeuControle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MeuControle.dll.so
		ptr null; void* handle (0x0)
	}, ; 447
...
@.env.3 = private unnamed_addr constant [37 x i8] c"6351db3b-8e9e-48d2-9e88-3a690c39e52c\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.meucontrole\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [26 x i8] c"libaot-MeuControle.dll.so\00", align 16
