...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2306575580, ; hash 0x897b8cdc, from name: MeuControle.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2558329574, ; hash 0x987d02e6, from name: aot-MeuControle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MeuControle.dll.so
		ptr null; void* handle (0x0)
	}, ; 281
	...
	%struct.DSOCacheEntry {
		i64 2682092134, ; hash 0x9fdd7a66, from name: libaot-MeuControle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MeuControle.dll.so
		ptr null; void* handle (0x0)
	}, ; 300
	...
	%struct.DSOCacheEntry {
		i64 2842206966, ; hash 0xa968a2f6, from name: aot-MeuControle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MeuControle.dll.so
		ptr null; void* handle (0x0)
	}, ; 322
	...
	%struct.DSOCacheEntry {
		i64 3246009350, ; hash 0xc17a2c06, from name: MeuControle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MeuControle.dll.so
		ptr null; void* handle (0x0)
	}, ; 373
	...
	%struct.DSOCacheEntry {
		i64 3739409364, ; hash 0xdee2dbd4, from name: libaot-MeuControle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MeuControle.dll.so
		ptr null; void* handle (0x0)
	}, ; 420
...
@.env.3 = private unnamed_addr constant [37 x i8] c"6435a88a-1a6d-4ea6-a435-fe0f4e14d679\00", align 1
